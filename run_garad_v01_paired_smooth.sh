...
cd "$SCRIPT_DIR"
BASE_OUT="analysis/garad_v01_paired_smooth_20260518"
mkdir -p "$BASE_OUT"
for cdw in 0.1 1.0; do
  tag="cd${cdw//./p}"
  COMMON=(--cpu --base-mode paired-smooth --train-limit 64 --eval-limit 32 --num-points 512 --batch-size 2 --base-alpha 0.08 --max-step 0.020 --lambda-cd "$cdw" --lambda-delta 1.0 --lambda-offset 0.0 --steps 160 --log-every 40)
...
base=Path('analysis/garad_v01_paired_smooth_20260518')
rows=[]
...
out=base/'paired_smooth_summary.csv'
